...
`define ALU_MUL     5'h0C
`define ALU_MULH    5'h0D
`define ALU_MULHU   5'h0E
`define ALU_DIV     5'h0F
`define ALU_DIVU    5'h10
`define ALU_REM     5'h11
`define ALU_REMU    5'h12
`define ALU_BGE     5'h13
`define ALU_BGEU    5'h14
